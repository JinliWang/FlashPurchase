...
public class CollectDownAdapter extends BaseAdapter<RecommendMoreResponse.ResponseBean.GoodsBean> {

    public CollectDownAdapter(List<RecommendMoreResponse.ResponseBean.GoodsBean> mDatas) {
        super(mDatas);
    }
