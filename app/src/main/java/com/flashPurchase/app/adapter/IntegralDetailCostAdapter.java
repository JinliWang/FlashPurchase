...
public class IntegralDetailCostAdapter extends BaseAdapter<MyIntegral.ResponseBean.CostBean> {
    public IntegralDetailCostAdapter(List<MyIntegral.ResponseBean.CostBean> mDatas) {
        super(mDatas);
    }
    ...
    class Holder extends BaseHolder<MyIntegral.ResponseBean.CostBean> {
