...
public class AucToBaskAdapter extends BaseAdapter<MyAucList.ResponseBean> {
    public AucToBaskAdapter(List<MyAucList.ResponseBean> mDatas) {
        super(mDatas);
    }
    ...
    class Holder extends BaseHolder<MyAucList.ResponseBean> implements View.OnClickListener {
        ...
        protected void refreshView() {
            ...
            mTvAucTime.setText("成交价格：" + getData().getActualPayment());
