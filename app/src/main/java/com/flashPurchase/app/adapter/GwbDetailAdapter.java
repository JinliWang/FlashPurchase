...
public class GwbDetailAdapter extends BaseAdapter<MyGwb.ResponseBean.JaExpireBean> {
    public GwbDetailAdapter(List<MyGwb.ResponseBean.JaExpireBean> mDatas) {
        super(mDatas);
    }
    ...
    class Holder extends BaseHolder<MyGwb.ResponseBean.JaExpireBean> {
