...
public class DealDetailAdapter extends BaseAdapter<MyIncome.ResponseBean.IncomeBean> {
    public DealDetailAdapter(List<MyIncome.ResponseBean.IncomeBean> mDatas) {
        super(mDatas);
    }
