...
public class RecommendAdapter extends BaseRecyclerAdapter<RecommendMoreResponse.ResponseBean.GoodsBean> {
    @Override
    public BaseRecycleHolder setViewHolder(ViewGroup parent) {
        return new RecommendAdapter.Holder(parent.getContext(), parent);
    }
