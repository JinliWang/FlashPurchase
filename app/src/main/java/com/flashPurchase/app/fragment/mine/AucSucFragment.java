...
public class AucSucFragment extends BaseFragment {
    ...
    private AucSucAdapter mMyAucAdapter;
    private List<MyAucList.ResponseBean> mList;
    private String mMessage;

    private WebSocketClient mWebSocketClient;

    public static AucSucFragment getInstance(String type) {
        AucSucFragment pane = new AucSucFragment();
    ...
    protected void initView(View view) {
        mList = new ArrayList<>();
        mMyAucAdapter = new AucSucAdapter(mList);
