...
public class SwipeBackManager {
    ...
    private SwipeBackManager() {
        ...
        config = new SlidrConfig.Builder()
                .primaryColor(getResources().getColor(R.color.title_bg))
                .secondaryColor(getResources().getColor(R.color.transparent))
                .position(SlidrPosition.LEFT)
                .sensitivity(1f)
                .scrimColor(getResources().getColor(R.color.title_bg))
