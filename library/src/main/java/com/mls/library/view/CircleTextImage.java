...
public class CircleTextImage extends AppCompatImageView {
    ...
    private void initAttr(Context context, AttributeSet attrs) {
        ...
        mCircleColor = typedArray.getColor(R.styleable.circletextview_circle_color, context.getResources().getColor(R.color.avater_bg));
        ...
        textSizeRatio = typedArray.getDimension(R.styleable.circletextview_circle_text_size, UIUtil.dip2px(14));
    ...
    private void refreshTextSizeConfig() {
        paintTextForeground.setTextSize(textSizeRatio);
